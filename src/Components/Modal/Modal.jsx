...
const Modal = ({children, openModal, setOpenModal}) => {
  return (
    <div id='wrapper' onClick={(e)=> e.target.id === "wrapper" && setOpenModal(false)} className={`fixed inset-0 bg-[#00000079] duration-300 ${openModal ? "scale-1" : "scale-0"} flex items-center justify-center backdrop-blur-sm`}>
